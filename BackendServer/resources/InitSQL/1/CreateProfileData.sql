CREATE TABLE IF NOT EXISTS profile_data (
    ...
    banner_item_id UUID NOT NULL,
    pre_spray_item_id UUID NOT NULL,
    match_spray_item_id UUID NOT NULL,
    post_spray_item_id UUID NOT NULL,
    attacker_outfit_loadout_id UUID NOT NULL,
    defender_outfit_loadout_id UUID NOT NULL,
    attacker_weapon_loadout_id UUID NOT NULL,
    defender_weapon_loadout_id UUID NOT NULL,
    ...
    CONSTRAINT verify_display_name CHECK (
        (display_name).player_name IS NOT NULL
        AND (display_name).discriminator IS NOT NULL
    )
);
