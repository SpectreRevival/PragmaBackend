...
public record class PlayerMatchmakingData
{
    ...
    public required string PriorityMatchmakingUntil { get; set; } = "0"; // todo replace this with a timestamp type
    public required string RestrictMatchmakingUntil { get; set; } = "0";
