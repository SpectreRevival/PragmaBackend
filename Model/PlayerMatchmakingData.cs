...
public record class PlayerMatchmakingData : IDatabaseSyncable<PlayerMatchmakingData, Guid>
{
    ...
    public static Task<PlayerMatchmakingData?> RetrieveFromDatabase(Guid key)
    {
